...
const int updateInterval = 100; // ms between position steps

// Movement limits
const int BASE_MIN = 0, BASE_MAX = 160;
const int LOWER_MIN = 0, LOWER_MAX = 155;
const int UPPER_MIN = 90, UPPER_MAX = 180;
